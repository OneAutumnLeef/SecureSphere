...
astraSmoothScroll = function(e, t) {
    ...
    function() {
        ...
        for (var t, a, o, l, h = function() {
                ...
                var e, t = document.querySelectorAll(".ast-account-action-login");
                if (t.length) {
                    const a = document.querySelector("#ast-hb-account-login-wrap");
                    a && (e = document.querySelector("#ast-hb-login-close"), t.forEach(function(e) {
            ...
            }, !1), S = navigator.userAgent, a = S.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i) || [], /trident/i.test(a[1]) ? t = /\brv[ :]+(\d+)/g.exec(S) || [] : "Chrome" === a[1] && null != (t = S.match(/\bOPR|Edge\/(\d+)/)) || (a = a[2] ? [a[1], a[2]] : [navigator.appName, navigator.appVersion, "-?"], null != (t = S.match(/version\/(\d+)/i)) && a.splice(1, 1, t[1]), "Safari" === a[0] && a[1] < 11 && document.body.classList.add("ast-safari-browser-less-than-11")), document.getElementsByClassName("astra-search-icon")), y = 0; y < f.length; y++) f[y].onclick = function(e) {
            var t;
        ...
        if (document.querySelectorAll(".search-field").forEach(e => {
            ...
            if (S)
                for (const link of S) link.href.split("#")[0] !== location.href.split("#")[0] ? t.push({
                    hash: link.hash,
